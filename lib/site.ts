export const siteConfig = {
  ...
  keywords: [
    ...
    "House Washing Ottawa",
    "Exterior Cleaning Services",
    "Driveway Pressure Washing",
    "Deck Cleaning Ottawa",
    "Siding Cleaning Ottawa",
    "Window Washing Kanata",
    "Window Cleaning Orleans",
    "Barrhaven Window Cleaners",
    "Nepean Pressure Washing",
    "Streak-Free Windows",
    "Eco-Friendly Cleaning Ottawa",
  ],
  url: "https://excelprowashers.com",
  ogImage: "https://excelprowashers.com/og-image.jpg",
  logo: "/logo.svg",
