...
export const metadata: Metadata = {
  ...
  description: 'Expert advice on window cleaning, pressure washing, soft washing, and home maintenance in Ottawa. Read our latest guides.',
}
    ...
    <div className="bg-white py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          <h1 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Expert Cleaning Tips for Ottawa Homes</h1>
          <p className="mt-2 text-lg leading-8 text-gray-600">
            Learn about window cleaning, soft washing, and property maintenance from Ottawa's top professionals.
          </p>
        </div>
